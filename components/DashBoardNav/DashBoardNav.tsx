...
const navigation = [
  ...
  { name: 'Create X Fund', icon: PlusCircleIcon, current: true ,href:'/createxfund'},
...
/*useEffect(() => {
  ...
  <Transition.Root show={sidebarOpen} as={Fragment}>
    <Dialog as="div" className="fixed inset-0 flex z-40 lg:hidden" onClose={setSidebarOpen}>
     ...
     >
       <div className="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-my-blue">
         <Transition.Child
           as={Fragment}
  ...
  {/* Static sidebar for desktop */}
   ...
   <div className="flex flex-col w-64">
     ...
     <div className="flex flex-col flex-grow bg-my-blue-alt7 pt-5 pb-4 overflow-y-auto">
...
XFund   </h1>
       ...
       <nav className="mt-5 flex-1 flex flex-col divide-y divide-my-blue-light overflow-y-auto" aria-label="Sidebar">
         <div className="px-2 space-y-1">
           {navigation.map((item) => (
             <Link
               key={item.name}
